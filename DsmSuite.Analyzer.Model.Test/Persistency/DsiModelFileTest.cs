...
namespace DsmSuite.Analyzer.Model.Test.Persistency
{
    ...
    public class DsiModelFileTest : IMetaDataModelFileCallback, IDsiElementModelFileCallback, IDsiRelationModelFileCallback
    {
        ...
        {
            string inputFilename = FilePath.ResolveRelativePath("../../../DsmSuite.Analyzer.Model.Test.Input.dsi");
        ...
        public void TestSaveModel()
        {
            string inputFilename = FilePath.ResolveRelativePath("../../../DsmSuite.Analyzer.Model.Test.Input.dsi");
            Assert.IsTrue(File.Exists(inputFilename));
            string outputFilename = FilePath.ResolveRelativePath("../../../DsmSuite.Analyzer.Model.Test.Output.dsi");
