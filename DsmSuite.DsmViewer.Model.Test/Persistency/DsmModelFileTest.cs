...
namespace DsmSuite.DsmViewer.Model.Test.Persistency
{
    ...
    public class DsmModelFileTest : IMetaDataModelFileCallback, IDsmElementModelFileCallback, IDsmRelationModelFileCallback, IDsmActionModelFileCallback
    {
        ...
        {
            string inputFilename = FilePath.ResolveRelativePath("../../../DsmSuite.DsmViewer.Model.Test.Input.dsm");
            Assert.IsTrue(File.Exists(inputFilename));

            DsmModelFile readModelFile = new DsmModelFile(inputFilename, this, this, this, this);
        ...
        public void TestSaveModel()
        {
            ...
            string outputFilename = FilePath.ResolveRelativePath("../../../DsmSuite.DsmViewer.Model.Test.Output.dsm");

            FillModelData();

            DsmModelFile writtenModelFile = new DsmModelFile(outputFilename, this, this, this, this);
